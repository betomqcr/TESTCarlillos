...
namespace ApiSuvesaPos.Controllers
{
    ...
    [Route("[controller]")]
    public class subUbicacionesController : Controller
    {
        public NegocioSuvesa.Interfaces.ISubUbicacionesManagerBL _subUbicacionesManager;

        public subUbicacionesController(NegocioSuvesa.Interfaces.ISubUbicacionesManagerBL subUbicacionesManager)
        {
            this._subUbicacionesManager = subUbicacionesManager;
        }
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<Datos.Helpers.ResponseGeneric<IEnumerable<Datos.DTOs.SubUbicacionesFilterInventarioDTO>>> ObtenerSubUbicacionesInventario()
        {
            try
            {
            ...
            {
                return new Datos.Helpers.ResponseGeneric<IEnumerable<Datos.DTOs.SubUbicacionesFilterInventarioDTO>>(ex);
            }
        }
