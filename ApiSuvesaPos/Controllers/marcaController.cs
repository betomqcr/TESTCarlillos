...
namespace ApiSuvesaPos.Controllers
{
    ...
    {
        public NegocioSuvesa.Interfaces.IMarcaManagerBL _marcaManager;

        public marcaController(NegocioSuvesa.Interfaces.IMarcaManagerBL marcaManager)
        {
            this._marcaManager = marcaManager;
        }
        ...
        public Datos.Helpers.ResponseGeneric<List<Datos.Models.Marca>> ObtenerMarcasInventario()
        {
            try
            {
                return _marcaManager.getMarcas();
            }
            catch (Exception ex)
            {
                return new Datos.Helpers.ResponseGeneric<List<Datos.Models.Marca>>(ex);
            }
        }
