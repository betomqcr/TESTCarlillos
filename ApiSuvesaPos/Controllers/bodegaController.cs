...
namespace ApiSuvesaPos.Controllers
{
    ...
    public class bodegaController : Controller
    {
        ...
        public NegocioSuvesa.Interfaces.IBodegasManagerBL _bodegasManager;

        public bodegaController(NegocioSuvesa.Interfaces.IBodegasManagerBL bodegasManager)
        {
            this._bodegasManager = bodegasManager;
        }
        ...
        public Datos.Helpers.ResponseGeneric<List<Datos.Models.Bodega>> ObtenerBodegas()
        {
            try
            {
            ...
            {
                return new Datos.Helpers.ResponseGeneric<List<Datos.Models.Bodega>>(ex);
            }
        }
