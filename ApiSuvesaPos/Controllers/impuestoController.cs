...
namespace ApiSuvesaPos.Controllers
{
    ...
    public class impuestoController : Controller
    {
        ...
        public NegocioSuvesa.Interfaces.IImpuestoManagerBL _impuestoManager;

        public impuestoController(NegocioSuvesa.Interfaces.IImpuestoManagerBL impuestoManager)
        {
            this._impuestoManager = impuestoManager;
        }
        ...
        public Datos.Helpers.ResponseGeneric<List<Datos.Models.Impuesto>> ObtenerImpuestos()
        {
            try
            {
                return _impuestoManager.getImpuestos();
            }
            catch (Exception ex)
            {
                return new Datos.Helpers.ResponseGeneric<List<Datos.Models.Impuesto>>(ex);
            }
        }
